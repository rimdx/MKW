 ...
 * AES192, AES256.
 * 
 * The implementation is verified against the test vectors in: National
...
/*
 * The round constant word array, Rcon[i], contains the values given by x to
 * the power (i-1) being powers of x (x is denoted as {02}) in the field
 * GF(2^8)
 */
