use crate::blobstore::{IBlobStore, entry::mkw_blobstore_entry_t, mkw_blobstore_txn_t, mkw_txn_result_t};
...
impl IBlobStore for mkw_blobstore_memory_t {
    ...
    where F : Fn(&mut mkw_blobstore_txn_t) -> mkw_txn_result_t<T, E>
    {
